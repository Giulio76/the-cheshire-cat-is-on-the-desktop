...
TrayTip "-The cat always appears where it is needed-`nshow or hide the window by pressing [INS]`ncycling between frames by pressing [F2]", "The Cheshire cat is on the desktop" , "48"
...
fn_gui_toggle_frame(HotkeyName)
{
  ...
  if (bln_A = 0) {
    ...
    ;  rettangolo
    WinSetRegion "10-90 508-90 508-1025 10-1025 " , "ahk_id " active_id   
    
    bln_A := 2
  }
  else if (bln_A = 2) {
    ;  rettangolo
    WinSetRegion "10-95 15-90 503-90 508-95 508-1020 503-1025 15-1025 10-1020 " , "ahk_id " active_id   
    
    bln_A := 3
  } 
  else if (bln_A = 3) {
    ; with the top bar
    WinSetRegion "10-2 508-2 508-1025 10-1025 " , "ahk_id " active_id    
    bln_A := 4
  } 
